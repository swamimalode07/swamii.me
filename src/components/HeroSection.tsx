          ...
          <div className="mb-20 flex max-w-7xl flex-col items-start justify-center pt-10 text-white sm:mt-18 md:pt-0 lg:mt-6">
            <div className="font-space-grotesk text-4xl tracking-tight leading-tight  font-semibold  sm:text-6xl md:text-7xl lg:text-8xl xl:text-[130px]">
             <div className="flex items-center gap-4">
              ...
              <span onClick={() => window.open("https://x.com/SwamiMalode", "_blank", "noopener,noreferrer")} className="text-[#27272A] hover:text-blue-500 hover:rotate-10 transform-fill transition-colors duration-150">
                <svg width="98" height="98" viewBox="0 0 70 70" fill="none" xmlns="http://www.w3.org/2000/svg">
